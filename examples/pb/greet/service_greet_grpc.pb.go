...
type GreetClient interface {
	Greet(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReturn, error)
}
...
func (c *greetClient) Greet(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReturn, error) {
...
type GreetServer interface {
	Greet(context.Context, *HelloRequest) (*HelloReturn, error)
...
func (UnimplementedGreetServer) Greet(context.Context, *HelloRequest) (*HelloReturn, error) {
...
func _Greet_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServer).Greet(ctx, req.(*HelloRequest))
	}
